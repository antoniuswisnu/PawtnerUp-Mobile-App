...
//
//    fun postQuestionnaire(petSizes: ArrayList<String>, petAges: ArrayList<String>, petGenders: ArrayList<String>, petBreeds: Int) : LiveData<ResultQuestionnaire>{
//        val result = MutableLiveData<ResultQuestionnaire>()
//        _isLoading.value = true
//        viewModelScope.launch{
//            try {
//                _isLoading.value = false
//                val response = repository.postQuestionnaire(petSizes, petAges, petGenders, petBreeds)
